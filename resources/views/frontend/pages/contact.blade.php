  ...
  <section class="bg0 p-t-104 p-b-116" ng-controller="contactController">
    <div class="container">
      ...
      <div class="row mt-4">
        ...
        <div class="col-md-12">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3928.8945725691697!2d105.77229117915759!3d10.0255581928687!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0882446239347%3A0xff0d773a5e93579f!2zVsSDbiBQaMOybmcgQ8O0bmcgQ2jhu6luZyBOZ3V54buFbiBUaGFuaCDEkMOsbmgocGjDsm5nIGPDtG5nIGNo4bupbmcgc-G7kSAxKQ!5e0!3m2!1sen!2s!4v1544585660212" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
      </div>
    </div>
  </section>  
    ...
    $scope.submitContactForm = function () {
      ...
      if ($scope.contactForm.$valid) {
       ...
       $http({
         ...
         swal('gui mai thanh cong', 'chung toi se tra loi quy khach trong thoi gian som nhat', 'success');
       }, function errorCallback(response){
         swal('co loi trong qua trinh gui mail', 'vui long thu lai sau vai phut', 'error');
